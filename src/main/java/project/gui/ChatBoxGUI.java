...
public class ChatBoxGUI extends JPanel {
    ...
    public ChatBoxGUI(String type_input, String dialogue_input) {
        ...
        this.setPreferredSize(new Dimension(400, 100)); // set size of ChatBox
        ...
        dialogue_type.setPreferredSize(new Dimension(80, 100)); // set size of index label
        ...
        dialogue.setPreferredSize(new Dimension(320, 100));
